...
# Build Flags
GO_LD_FLAGS= "-s -w -X github.com/kenlabs/pandofg/pkg/version.RELEASE=${RELEASE} -X github.com/kenlabs/pandofg/pkg/version.COMMIT=${GIT_COMMIT} -X github.com/kenlabs/pandofg/pkg/version.REPO=${GIT_REPO_INFO}"
